...
function deposit() {
  formArea.innerHTML = `
    ...
    <button class="btn primary" onclick="doDeposit()">Confirmar</button>
    <button class="btn" onclick="clearForm()">Cancelar</button>
  `;
}
...
function withdraw() {
  formArea.innerHTML = `
    <input id="amount" type="number" placeholder="Valor" min="1" step="0.01">
    <button class="btn primary" onclick="doWithdraw()">Confirmar</button>
    <button class="btn" onclick="clearForm()">Cancelar</button>
  `;
}
